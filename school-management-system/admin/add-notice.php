...
if ((isset($_SESSION['admin_id']) || isset($_SESSION['teacher_id'])) && 
    isset($_SESSION['role'])) { //check session variables are set

    if ($_SESSION['role'] == 'admin' || $_SESSION['role'] == 'teacher') { //verify roles
      
       $event = '';
       $date = '';

       if (isset($_GET['event'])) $event = $_GET['event']; //GET method to get notice
